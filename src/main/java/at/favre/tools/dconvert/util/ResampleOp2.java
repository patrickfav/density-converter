...
/**
 * Created by PatrickF on 13.04.2016.
 */
 ...
 * @author Heinz Doerr
 */
public class ResampleOp2 extends AdvancedResizeOp
{
    ...
    public ResampleOp2(int destWidth, int destHeight) {
        this(DimensionConstrain.createAbsolutionDimension(destWidth, destHeight));
    }

    public ResampleOp2(DimensionConstrain dimensionConstrain) {
...
//                    BufferedImage.TYPE_4BYTE_ABGR : BufferedImage.TYPE_3BYTE_BGR);
    ...
    static SubSamplingData createSubSampling(ResampleFilter filter, int srcSize, int dstSize) {
        ...
        if (scale < 1.0f) {
            ...
            numContributors= (int)(width * 2.0f + 1); // Heinz: added 1 to be save with the ceilling
