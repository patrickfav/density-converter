...
public enum EScalingAlgorithm {
    LANCZOS1(new ResambleAlgorithm(new ResambleAlgorithm.LanczosFilter(1)), "lanczos1", Arrays.asList(Type.DOWNSCALING, Type.UPSCALING)),
    LANCZOS2(new ResambleAlgorithm(new ResambleAlgorithm.LanczosFilter(2)), "lanczos2", Arrays.asList(Type.DOWNSCALING, Type.UPSCALING)),
    LANCZOS3(new ResambleAlgorithm(new ResambleAlgorithm.LanczosFilter(3)), "lanczos3", Arrays.asList(Type.DOWNSCALING, Type.UPSCALING)),
    LANCZOS4(new ResambleAlgorithm(new ResambleAlgorithm.LanczosFilter(4)), "lanczos4", Arrays.asList(Type.DOWNSCALING, Type.UPSCALING)),
